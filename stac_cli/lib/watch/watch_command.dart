...
/// Result of building one target — PLUG IN: replace the body of
/// `WatchCommand._build` with a call into your existing BuildService,
/// returning the same shape (raw JSON string for that one screen/theme).
...
class WatchCommand {
  ...
  late final FlutterProcessController _flutterCtrl;
  KeyCommands? _keys;
