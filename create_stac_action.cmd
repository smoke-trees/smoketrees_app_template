@echo off
setlocal
rem Windows launcher for create_stac_action.sh so it works from ANY terminal
...
rem
rem Usage:
rem   create_stac_action.cmd SubmitOrder
rem   create_stac_action.cmd SubmitOrder checkout

set "ROOT=%~dp0"
set "SH=create_stac_action.sh"
